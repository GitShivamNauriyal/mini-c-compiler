...
# C++ source files
CPP_SRCS = $(SRC_DIR)/ast.cpp $(SRC_DIR)/symbol_table.cpp $(SRC_DIR)/semantic.cpp $(SRC_DIR)/codegen.cpp $(SRC_DIR)/optimizer.cpp $(SRC_DIR)/mips_gen.cpp $(SRC_DIR)/main.cpp
all: $(TARGET)
